...
export default function Opinions() {
    const text = "Zakupy w City Kicks to czysta przyjemność. Mają naprawdę imponujący asortyment butów – od klasycznych sneakersów po najnowsze modele od topowych marek. Plus za szybkie realizowanie zamówień i konkurencyjne ceny. Na pewno będę wracać!";
    return (
